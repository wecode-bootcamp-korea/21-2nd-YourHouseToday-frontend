      ...
      <>
        {pathname !== '/writing' ? (
          <Container>
            ...
            <Info>
              상호명(주)오늘의 너네집 이메일(고객문의) yourhousetoday.net
              (제휴문의) yourhousetoday.net
              ...
              체결하여 안전거래를 보장하고 있습니다. 서비스가입사실 확인
              (주)오늘의 너네집은 통신판매중개자
              <br />
              <br />
              로서 통신판매의 당사자가 아니며, 입점업체가 등록한 상품, 상품정보
              및 거래에 대하여 (주)오늘의 너네집은 일체 책임을 지지 않습니다.
              <br />
              <br />
              <span>
